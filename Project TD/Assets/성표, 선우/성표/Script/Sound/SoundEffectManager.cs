...
public class SoundEffectManager : SingletonMonoBehaivour<SoundEffectManager>
{
    ...
    {
        SoundEffect sound = (SoundEffect)PoolManagers.Instance.ReuseComponent(soundEffect.soundPrefab, Vector3.zero, Quaternion.identity);
